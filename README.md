...
- [⚡ Enterprise Data Tables & Filtering](#-enterprise-data-tables--filtering)
- [📝 Full-Width Multi-Step Form Wizard](#-full-width-multi-step-form-wizard)
- [🛡️ Error Handling, RBAC & Interceptors](#️-error-handling-rbac--interceptors)
- [⌨️ Global Command Palette (`Cmd+K`)](#️-global-command-palette-cmdk)
- [🛠️ Tech Stack & Requirements](#️-tech-stack--requirements)
- [🚀 Quick Start & Development Commands](#-quick-start--development-commands)
- [🗺️ Complete Route Sitemap](#️-complete-route-sitemap)
...
| **🌓 Theme Modes** | **Zero-Flash Light/Dark** | Head IIFE script + 0ms repaint transition suppressor | ✅ Ready |
| **📊 SVG Charts** | **Zero-Dependency Suite** | AreaChart with bezier curves, DonutChart with hover expansion, MetricSparklines & BarCharts | ✅ Ready |
| **⚡ Data Table** | **Enterprise Table** | Single-line pagination (`Page 1 of 2`), multi-column sorting, search & selection | ✅ Ready |
| **📝 Form Wizard** | **4-Step Form Wizard** | Multi-step form with Zod schema validation, required asterisks & responsive layout | ✅ Ready |
...
## 🤖 AI Engineering Copilot (Chatbox)
...
- **Quick Prompt Carousel**:
  ...
  - 🧪 *Add Vitest Unit Test*: Generate unit tests with 100% edge case coverage.
  - 🔧 *Inspect MCP Tools*: List connected MCP tools with parameter schemas.
  - 🐛 *Debug Errors*: Analyze potential runtime exceptions and memory leaks.
...
## 🔤 20 Google Fonts Dynamic Loader
...
## 📝 Full-Width Multi-Step Form Wizard

- **4 Guided Steps**: Personal Information ➔ Account Setup ➔ Business Details ➔ Final Review & Confirmation.
...
## 🛡️ Error Handling, RBAC & Interceptors
...
- **Custom Error Pages**:
  - `/403` — Access Forbidden / Role Restricted Page
...
- 🏛️ [ARCHITECTURE.md](./ARCHITECTURE.md) — System Architecture, Folder Structure & State Management.
- ⚙️ [ENVIRONMENT.md](./ENVIRONMENT.md) — Environment Variable Schemas & Base API Configuration.
- 🚀 [DEPLOYMENT.md](./DEPLOYMENT.md) — Docker, NGINX, Vercel & Netlify Deployment Guides.
- 🤝 [CONTRIBUTING.md](./CONTRIBUTING.md) — Code Style Guidelines, Git Hooks & Conventional Commits.
