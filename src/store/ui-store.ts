...
const getInitialActiveRightPanel = (): 'chat' | 'mcp' | 'theme' | 'telemetry' | 'i18n' | 'docs' | null => {
...
export type RightPanelType = 'chat' | 'mcp' | 'theme' | 'telemetry' | 'i18n' | 'docs' | null;
...
interface UIState {
  ...
  toggleRightPanel: (panel: 'chat' | 'mcp' | 'theme' | 'telemetry' | 'i18n' | 'docs') => void;
